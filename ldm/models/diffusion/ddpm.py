...
class DiffusionWrapper(pl.LightningModule):
    ...
    def forward(self, x, t, c_concat: list = None, c_crossattn: list = None,c_film: list = None, name=None):
        ...
        if self.conditioning_key is None:
            ...
            # xc = torch.cat([x] + c_concat, dim=1)   # [B, dim, seq_len]
            # if isinstance(c_crossattn, list):
            #     cc = torch.cat(c_crossattn, 1)  # [b,seq_len,dim]
            # else:
            #     cc = c_crossattn
